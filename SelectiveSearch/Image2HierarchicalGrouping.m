function [boxes, blobIndIm, blobBoxes, hierarchy, priority] =...
...
% Change colour space
[colourIm, ~] = Image2ColourSpace(im, colourType);
...
[blobIndIm, blobBoxes, neighbours] = mexFelzenSegmentIndex(colourIm, sigma, k, minSize);
...
blobStruct.neighbours = neighbours;
