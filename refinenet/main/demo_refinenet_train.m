...
% model_name='model_20170122_sal';

% update the model name when reducing learning rate for training, e.g.,
model_name='model_20170122_sal_epoch200_low_learn_rate';



% ds_name='voc2012_trainval';
ds_name='sal_trainval';
% gen_ds_info_fn=@my_gen_ds_info_voc;
gen_ds_info_fn=@my_gen_ds_info_sal;
...
ds_config.ds_info_cache_dir=fullfile('/home/lab/lei', ds_name);
